...
/**
 * Generated class for the CovidinfoPage page.
 *
...
export class CovidinfoPage {
  ...
  //deklarasi object untuk covidId
  ...
  // deklarasi object untuk covidWorld
  // tidak di buat model karena pemakaian hanya sekali
  covidWorld={
    'confirmed': 0,
    'recovered': 0,
    'deaths': 0,
  ...
  // variable bertipe anv untuk menampung hasil
  // dari end point 
  result:any;
  ...
  getKasusIndonesia(){
    this.covidInfo.getIdCovid().subscribe(
      result=> {
        this.result = result;
        // memasukkan data dari end point ke object covidId
        this.covidId.confirmed =
        parseInt(this.result.confirmed.value);
        this.covidId.activeCare =
        parseInt(this.result.activeCare.value);
        this.covidId.deaths = parseInt(this.result.deaths.value);
        this.covidId.recovered = 
        parseInt(this.result.recovered.value);
  ...
  getKasusDunia(){
    this.covidInfo.getWorldCovid().subscribe(
      result => {
        this.result = result;
        // memasukkan data dari end point ke object covidWorld
        this.covidWorld.confirmed =
        parseInt(this.result.TotalConfirmed);
        this.covidWorld.recovered =
