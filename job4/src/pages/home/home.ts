...
import { UserAccount } from '../../models/user/user-models';
...
menu: MenuController, private toast: ToastController, private productProvider: ProductProvider, private favoriteProvider: FavoriteProvider) {
 menu.enable(true);
